...
(async () => {
    try {
        ...
        console.log("Testing simulation with NUMBER AS STRING (Simulates Multer/FormData)...");
        const payload = {
            nombre_producto: 'Test String Number',
            descripcion: 'Desc',
            foto_url: null,
            cantidad_disponible: '10.5', // STRING!
            unidad_medida: 'Quintal',
            precio_unitario: '25.00', // STRING!
        ...
        console.log("✅ SUCCESSFUL SIMULATION (String numbers worked)");
        process.exit(0);
    } catch (err) {
