...
import { Search, Filter, CheckCircle, XCircle, FileText, Eye, X, Loader2, AlertCircle, Users, Clock, Star } from 'lucide-react';
      ...
      <div className="bg-white rounded-2xl shadow-md border border-gray-200 overflow-hidden">
        ...
        <div className="overflow-x-auto">
          ...
          <div className="p-12 text-center text-gray-400">
              <span className="text-5xl block mb-3"><Star size={16} className="inline-block mr-1" /></span>
