...
const DashboardCompradorPage = () => {
  ...
  const stats = [
    { label: 'En tu carrito', value: cartItemCount, suffix: 'items', icon: ShoppingCart, gradient: 'from-emerald-500 to-indigo-600', bgLight: 'bg-emerald-50', textColor: 'text-emerald-600' },
  ...
  return (
    <div className="p-5 sm:p-8 lg:p-10 space-y-7 max-w-7xl mx-auto">
      ...
      <div className="relative overflow-hidden rounded-3xl animate-slide-up">
        ...
        <div className="absolute top-[-30%] right-[-10%] w-[450px] h-[450px] bg-emerald-500/10 rounded-full blur-[80px] animate-float" />
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-6">
            ...
            <div className="flex gap-3 shrink-0">
              <button
                ...
                className="bg-gradient-to-r from-emerald-500 to-emerald-600 hover:from-emerald-600 hover:to-emerald-700 text-white px-6 py-3.5 rounded-2xl font-bold text-sm transition-all duration-500 flex items-center gap-2.5 shadow-xl shadow-emerald-500/20 hover:shadow-2xl hover:-translate-y-0.5 group"
              >
      ...
      <div className="animate-slide-up" style={{ animationDelay: '0.15s' }}>
        <h2 className="text-lg font-black text-slate-900 mb-4 flex items-center gap-2">
          <Zap className="w-5 h-5 text-emerald-500" /> Acceso rápido
        </h2>
            ...
            return (
              ...
              >
                <div className="flex items-start justify-between mb-5">
                  ...
                  <ArrowUpRight className="w-4 h-4 text-slate-300 group-hover:text-emerald-600 group-hover:translate-x-1 group-hover:-translate-y-1 transition-all duration-300" />
                </div>
      ...
      <div className="animate-slide-up" style={{ animationDelay: '0.2s' }}>
        ...
        <div className="space-y-3">
          ...
          <div className="card-elevated p-5 flex items-start gap-4 group">
            <div className="w-11 h-11 bg-gradient-to-br from-emerald-400 to-indigo-500 text-white rounded-xl flex items-center justify-center shrink-0 shadow-lg group-hover:scale-110 transition-all duration-300">
