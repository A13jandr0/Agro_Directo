                            ...
                            pendingUsers.map(user => (
                                <tr key={user.Id} className="bg-white border-b hover:bg-gray-50">
                                    ...
                                    <td className="px-6 py-4">
                                        <span className={`px-2 py-1 rounded text-xs ${user.Rol === 'Productor' ? 'bg-green-100 text-green-800' : 'bg-emerald-100 text-emerald-800'}`}>
                                            {user.Rol}
                                        </span>
                                    </td>
                                    <td className="px-6 py-4">{user.FechaRegistro}</td>
                                    <td className="px-6 py-4">
                                        <a href={user.DocumentoIdentidad || user.LicenciaConducir} target="_blank" rel="noreferrer" className="text-emerald-600 hover:underline">
                                            Ver Documento
                                        </a>
                                    </td>
